...
module.exports = {
    name: "help",
    description: "Detailed list of Calefaction's commands.",
    ...
    async run(client, message, args) {
        ...
        const embed = new Discord.MessageEmbed()
            .setAuthor("Commands", "https://i.imgur.com/NVOshbv.png") // TODO: New icon here
            .setDescription(`Help menu for Calefaction`)
